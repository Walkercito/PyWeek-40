...
class BuildingManager:
    ...
    def setup_instancing(self):
        ...
        if not exists(vs_path) or not exists(fs_path):
            print(f"Warning: Building instancing shaders not found!")
        ...
        if self.building_data["simple"]:
            ...
            if transforms:
                try:
                    ...
                    if DEBUG:
                        print(f"Simple building instancing failed: {e}")
        ...
        if self.building_data["complex"]:
            ...
            if transforms:
                try:
                    ...
                    if DEBUG:
                        print(f"Complex building instancing failed: {e}")
    ...
    def draw_individual_type(self, building_type):
        ...
        for building_data in self.building_data[building_type]:
            ...
            draw_model_ex(model, pos, Vector3(0, 1, 0), rot, Vector3(1, 1, 1), material.maps[MATERIAL_MAP_DIFFUSE].color)
